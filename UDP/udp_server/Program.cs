...
namespace client_udp //server
{
    class Program
    {
        static string path = "C:\\workspace\\FTP\\ftp";
        static void Main(string[] args)
        {
            Console.WriteLine("YOU ARE SERVER");
        ...
        static void Reciever()
        {
            ...
            string message;
            Console.WriteLine("Server ready to recieve message");
